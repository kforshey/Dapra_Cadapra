...
#pragma warning restore 618
        ...
        /// <summary>
        /// Bulk sql query execution
        /// give it the list of queries and also the command type to run.
        /// </summary>
        /// <param name="cnn"></param>
        /// <param name="queries"></param>
        /// /// <param name="comtype"></param>
        public static void ExecuteMany(this IDbConnection cnn, List<String> queries, CommandType comtype)
        {
            ...
            cnn.Execute(sql, null, null, 300, comtype);
        ...
        public static void Insert(this IDbConnection cnn, string table, Dictionary<Object, Object> fields)
        {
            String sql = @"Insert into " + table + @"(";
            List<Object> columns = fields.Keys.ToList<Object>();
            List<Object> vals = fields.Values.ToList<Object>();
            int x = 0;
            foreach (Object s in columns)
            {
                if (x != fields.Count)
                {
                    sql += s.GetType().ToString() + @", ";
                }
                else
                {
                    sql += s.GetType().ToString() + @") values(";
                }
                x++;
        ...
        /// <summary>
        /// Update the provided table 
        /// set the passed in colum to the passed
        /// in value where it matches the provided
        /// where clause
        /// </summary>
        /// <param name="cnn"></param>
        /// <param name="table"></param>
